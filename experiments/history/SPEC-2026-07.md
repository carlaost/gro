> **HISTORICAL, FROZEN (2026-07-15).** This is the July 2026 draft that came out of the format
> tournament. It fuses the record *shape* with measuring machinery (rigor tiers, a metrics
> catalogue, judge protocols, a "credibility dossier"). That fusion was a mistake and is
> dropped: GRO is the schema people publish in, and measuring is done by funders, curators
> and validators on their side. The current schema is [`../../spec/`](../../spec/). This file
> is kept unedited as the record of how the shape was arrived at.
