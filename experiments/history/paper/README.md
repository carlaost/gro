...
It is a *digest*: where it summarises, the rest of the repository carries the full text (the complete GRO spec in [`../SPEC.md`](../SPEC-2026-07.md), the metrics program in [`../metrics/`](../metrics/), the tournaments in [`../metrics/tournaments/`](../../metrics/tournaments/)). The limitations section folds in the honest gaps from the author's Astera and SPRU research programs (validation, scale, trust-relocation, adoption).
